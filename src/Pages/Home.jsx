     ...
     "
        ...
        <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid-cols-1 lg:grid-cols-2">
          <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
            <div className="w-full lg:pr-24 mx-auto max-w-312">
              <motion.div
                className="mb-3 text-xl sm:text-2xl md:text-4xl lg:text-4xl font-semibold
               text-white tracking-wide min-h-[1.6em]"
              ...
              >
                I turn complex idea into seamless, high-impact web experiences - building modern, scalable, and 
                lightning-fast application that make a difference.
              </motion.p>
